...
if unit <=100:
	...
	print("Enter units consumed:",unit*5)

elif unit > 100 and unit<=200:

	nexts  = unit- 100 # 100 * 5 + 50*7
	print("Enter units consumed: ",((nexts*7)+500))


else :  
	nexts  = unit- 200 # 100*5 + 100 *7 + 50 *10
	print("Enter units consumed: ",((nexts*10)+1200))
